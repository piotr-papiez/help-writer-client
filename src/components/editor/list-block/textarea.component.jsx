...
export default function Textarea({ onInput, point, onAddIndent, onRemove, onFocus, setListContent, ref }) {
    return (
        <div className={styles["list-wrapper"]}>
            <div className={styles["textarea-wrapper-first-level"]}>
                ...
                <TextareaAutosize
                    ...
                    onKeyDown={event => handleKeyFormatting(event, setListContent)}
                    value={point.content}
